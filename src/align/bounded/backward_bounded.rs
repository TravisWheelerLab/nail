...
pub fn backward_bounded(
    ...
    dp_matrix.set_special(params.target_start, Profile::SPECIAL_J_IDX, -f32::INFINITY);
    dp_matrix.set_special(params.target_start, Profile::SPECIAL_B_IDX, -f32::INFINITY);
    dp_matrix.set_special(params.target_start, Profile::SPECIAL_N_IDX, -f32::INFINITY);
    ...
    dp_matrix.set_match(
        ...
        dp_matrix.get_special(params.target_end, Profile::SPECIAL_E_IDX),
    );
    ...
    for profile_idx in (profile_start_on_last_row..profile_end_on_last_row).rev() {
        dp_matrix.set_match(
            ...
            profile_idx,
            log_sum!(
                dp_matrix.get_special(params.target_end, Profile::SPECIAL_E_IDX) + end_score,
    ...
    for profile_idx in (profile_start_in_first_row + 1)..=profile_end_in_first_row {
        dp_matrix.set_special(
            ...
            Profile::SPECIAL_B_IDX,
            log_sum!(
                dp_matrix.get_special(params.target_start - 1, Profile::SPECIAL_B_IDX),
    ...
    dp_matrix.set_special(
        ...
        Profile::SPECIAL_N_IDX,
        log_sum!(
            dp_matrix.get_special(params.target_start, Profile::SPECIAL_N_IDX)
                + profile
